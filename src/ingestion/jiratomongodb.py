...
if __name__ == "__main__":
        try:
            processed_data = asyncio.run(process_all_issues("68696f783ad17ea0c39cbc65"))
            logger.info(f"--- Script Finished: Successfully processed {len(processed_data)} issues in total. ---")
